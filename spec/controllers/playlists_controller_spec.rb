...
RSpec.describe PlaylistsController, type: :controller do
  describe "POST #create" do
    ...
    context "with invalid params" do
      it "assigns newly reated but unsaved playlist as @playlist" do
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "redirects newly updated playlist to @playlist" do
        playlist = create(:playlist)
        put :update, {:id => playlist.to_param, :playlist => attributes_for(:playlist, name: "New Name")}
    ...
    context "with invalid params" do
      it "assigns the newly created but not saved playlist as @playlist and redirects to edit" do
        playlist = create(:playlist)
